    ...
    return (
         <>
            <div className="w-[300px] bg-white h-full fixed border-r border-[#e4e5e7] shadow-md">
                <div className="mt-[20px] p-[10px] flex flex-col">
                        <h1 className="text-2xl font-bold text-black pl-[15px]">Client dashboard</h1>
                    <div className="flex pl-[15px] mt-[50px]">
                        ...
                        <div className="ml-[10px]">
                            ...
                            <div className="w-fit h-[20px] rounded-full bg-[#108a0036] flex items-center justify-center mt-[5px]">
                                <span className="text-xs pl-[10px] pr-[10px]">Client</span>
                            </div>
                        </div>
                    </div>  
