                ...
                <div className="flex h-full w-full">
                    <div className="flex flex-1">
                        <div className="p-[30px]">
                            <span className="text-xl font-semibold line-clamp-1 text-[#404145]">Create book: How to catch girls</span>

                            <div className="mt-[10px]">
                                <div className="w-fit h-[20px] bg-[#28a746] rounded-full flex items-center justify-center">
                                    <span className="text-xs pl-[10px] pr-[10px] text-white">Active</span>
                                </div>
                            </div>
                            <p className="text-sm line-clamp-2 mt-[10px] leading-[1.5] text-[#62646a]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia, molestiae quas vel sint commodi repudiandae consequuntur voluptatum laborum numquam blanditiis</p>
                            ...
                            <div className="mt-[15px]">
                                <div className="flex items-start">
                                    ...
                                    {/* <div className="flex items-center pr-[10px] mr-[10px] border-r border-[#EAEAEA]"> */}
                                        ...
                                        {/* <span className="text-sm">Progress: <span className="font-bold text-[#28a746]">70% done</span></span> */}
                                    {/* </div> */}
                                </div>
                            </div>
                            ...
                            <div className="mt-[20px] w-full">
                                <div className="flex items-start flex-col w-full">
                                    <div className="flex items-center">
                                        <span className="text-sm">Attachemnts:</span>
                                    </div>
                                    <div className="flex items-center mt-[10px] w-full">
                                        ...
                                        <div className="w-full h-[50px] rounded-[10px] bg-[#f0f0f0] flex items-center justify-center ml-[10px]">
                                            <div className="p-[10px] flex items-center">
