...
const Dashboard = ({
    ...
    return (
         <>
          <div className="mt-[33px] container max-w-7xl px-4 w-full flex flex-col h-full">
               <h1 className="h-1 font-bold text-2xl mt-[20px]">Milestone</h1>
               <div className="flex relative mt-[50px] h-full">
                    ...
                    <div className="w-fit h-full relative">
                         <div className="w-[350px] sticky ml-[30px] top-[120px] left-0">
                              <div className="p-[20px] w-full border bg-white shadow-sm rounded-[10px] mb-[20px]">
                                   <span className="text-base font-semibold text-[#222325]">Client details</span>
                              ...
                              <div className="w-full mt-[20px]">
                                   <Button className="w-full">Chat with Ilija Holly</Button>
                              </div>
                         </div>  
                    </div>
