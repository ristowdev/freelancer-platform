...
export const columns: ColumnDef<ProposalData>[] = [
            ...
            return(
                <div className="flex text-left items-center">
                    <Avatar className="w-[25px] h-[25px] bg-green-800 flex items-center justify-center mr-[10px]">
                        <AvatarImage src={row.original.clientImageUrl} />
                        <AvatarFallback className="text-sm text-white">{row.original.clientName[0]}</AvatarFallback>
                    </Avatar>
    ...
    {
        id: "actions",
        cell: ({ row }) => <ProjectsActionsCell pId={row.original.id as Id<"projects">}  status={row.original.status}/>
    },
]
